...
if [[ "${RESIDUAL_MERGE_MODE,,}" == "a2c2" ]]; then
  export RESIDUAL_MERGE_MODE="fast_wrist"
fi
...
EOF
    ...
    if is_true "$DRY_RUN"; then
      ...
      print_assignment FAST_RESIDUAL_ALPHA "$FAST_RESIDUAL_ALPHA"
      print_assignment FAST_RESIDUAL_USE_LATENT_CONTEXT "$FAST_RESIDUAL_USE_LATENT_CONTEXT"
