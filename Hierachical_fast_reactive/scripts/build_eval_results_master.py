...
METADATA_PROFILES = {
    ...
    "hfrvla_fwr_generated_b1024p3_50k": {
        "policy_family": "hfrvla",
        "checkpoint_id": "hfrvla_fwr_chunk_generated_seq2_b1024p3_50k",
        "checkpoint_path": "checkpoints/hfrvla_fwr_chunk_generated_seq2_b1024p3_50k_packaged",
        "train_run_name": "hfrvla_fwr_chunk_generated_seq2_b1024p3_50k",
        "train_steps": "50000",
        "seq_len": "2",
        "residual_merge_mode": "fast_wrist_chunk",
        "latent_context": "true",
        "eval_alpha_default": "0.5",
        "eval_delta_max_default": "0.2",
        "notes": "generated-chunk FWR checkpoint; formal spatial 10x10 sweeps use alpha=0.5, delta_max=0.2",
    },
    "smolvla_libero": {
...
SWEEP_PROFILES = {
    ...
    "async_timestep_planner_delay_eval_sweep": {
        "sweep_type": "planner_delay_sweep",
        "comparison_axis": "planner_delay_steps",
    },
}
