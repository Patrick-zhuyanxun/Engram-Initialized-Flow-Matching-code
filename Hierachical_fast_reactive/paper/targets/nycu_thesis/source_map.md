...
|---|---|---|
| Problem schematic | `paper/src/figures/fig1_problem_schematic.*` | Chapter 1 figure. Must show Gantt-style continuous execution chunks, next SmolVLA inference overlapping only the tail of the active execution chunk, stale feedback during long execution, and H/e/K/d definitions. |
