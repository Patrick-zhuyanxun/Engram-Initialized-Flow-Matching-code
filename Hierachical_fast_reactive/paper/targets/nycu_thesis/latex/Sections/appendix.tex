...
\begin{enumerate}
  \item 研究想法：bounded fast wrist correction for frozen VLA chunks。
  ...
  \item 研究架構：slow planner + fast wrist correction。
...
\begin{itemize}
  \item \textcolor{red}{Dual-view DINO fast correction ablation}：wrist + third-person image fast model。
