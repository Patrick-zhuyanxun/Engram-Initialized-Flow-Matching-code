...
在第 $k$ 個 chunk position 執行時，base action 為 $\abase=a_t^k$。若 robot 與環境已經偏離 $A_t$ 生成時的 observation，則 $\abase$ 可能不再是最佳 action。\method{} 以 fast wrist correction module $f_\theta$ 預測：
